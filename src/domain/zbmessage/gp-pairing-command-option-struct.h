...
class CGpPairingCommandOption
{
    ...
    private:
        /**
         *  Bit 0..2: The ApplicationID sub-field contains t 3388 he information about the application used by the GPD. 
         ...
         * Bit 8: see upper
         */
        bool gpd_mac_seq_number_capability;
        /**
         ...
         */
        bool gpd_security_frame_counter_present;
        /**
         * Bit 15: see upper
         */
