...
TEST(gp_tests, gp_recv_sensor_measurement) {
	...
	UT_WAIT_MS(50);
	mockUartDriverHandle->scheduleIncomingChunk(MockUartScheduledByteDelivery({0x38, 0x1c, 0x0e, 0x07, 0xbb, 0xe5, 0xca, 0x3e, 0xe5, 0x7e}));
	UT_WAIT_MS(100);
	UT_FAILF_UNLESS_STAGE(stageExpectedTransitions.size());
	...
	UT_WAIT_MS(50);
	mockUartDriverHandle->scheduleIncomingChunk(MockUartScheduledByteDelivery({0x38, 0x1c, 0x0e, 0x07, 0xbb, 0xe5, 0xca, 0xdc, 0xec, 0x7e}));
	UT_WAIT_MS(100);
	UT_FAILF_UNLESS_STAGE(stageExpectedTransitions.size());
	...
	UT_WAIT_MS(50);
	mockUartDriverHandle->scheduleIncomingChunk(MockUartScheduledByteDelivery({0x38, 0x1c, 0x0e, 0x07, 0xbb, 0xe5, 0xca, 0x42, 0x9a, 0x7e}));
	UT_WAIT_MS(100);
	UT_FAILF_UNLESS_STAGE(stageExpectedTransitions.size());
	...
	UT_WAIT_MS(50);
	mockUartDriverHandle->scheduleIncomingChunk(MockUartScheduledByteDelivery({0x38, 0x1c, 0x0e, 0x07, 0xbb, 0xe5, 0xca, 0xa0, 0x93, 0x7e}));
	UT_WAIT_MS(100);
	UT_FAILF_UNLESS_STAGE(stageExpectedTransitions.size());
	...
	UT_WAIT_MS(50);
	mockUartDriverHandle->scheduleIncomingChunk(MockUartScheduledByteDelivery({0x38, 0x1c, 0x0e, 0x07, 0xbb, 0xe5, 0xca, 0xac, 0x7a, 0x7e}));
	UT_WAIT_MS(100);
	UT_FAILF_UNLESS_STAGE(stageExpectedTransitions.size());
	...
	UT_WAIT_MS(50);
	mockUartDriverHandle->scheduleIncomingChunk(MockUartScheduledByteDelivery({0x7e}));
	UT_WAIT_MS(100);
	UT_FAILF_UNLESS_STAGE(stageExpectedTransitions.size());
